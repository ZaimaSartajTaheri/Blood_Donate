...
if(isset($deletesubmitError)) echo $deletesubmitError;
      ...
      ?>
        ...
        <div class="form-group">
          ...
          <input type="text"
        name="name" id="fullname" placeholder="Full Name"  pattern="[A-Za-z/\s]+" title="Only lower and upper case and space" class="form-control" value="<?php
...
if(isset($emailError)) echo $emailError;
      ?>
          ...
          <div class="form-group">
            <label for="contqact_no">Contact No</label>
             <input type="text" name="contact_no"  placeholder="03********" class="form-control" required pattern="^\d{11}$" title="11 numeric characters only" maxlength="11" value="<?php
