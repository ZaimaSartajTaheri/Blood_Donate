...
<div class="container-fluid header-img" style="height: 400px;">
				<div class="row">
					<div class="col-md-6 offset-md-3">

						<div class="header">
							<h1 class="text-center" style="color: white;">Donate the blood, save the life</h1>
						<p class="text-center" style="color: white;">Donate the blood to help the others.</p>
						</div>


						<h1 class="text-center" style="color: white;">Search The Donors</h1>
			...
			<div class="container-fluid red-background" >
				<div class="row ">
					<div class="col-md-12 text-center">
						<h1 class="text-center mt-3"  style="color: white; font-weight: 700;padding: 10px 0 0 0;">Donate The Blood</h1>
						<hr class="white-bar" style="width: 25%;">
						<p class="text-center pera-text mt-3">
						...
						<a href="donate.php" class="btn bg-light btn-default mt-5 btn-lg text-center center-aligned" style=" color: #e74c3c;  ">Become a Life Saver!</a>
					</div>
				</div>
			</div>
			<!-- end doante section -->
