...
if(isset($_POST['name']) && !empty($_POST['name'])){
    ...
    <span aria-hidden="true">&times;</span>
       ...
       if(isset($_POST['blood_group']) && !empty($_POST['blood_group'])){
      	...
      	$bloodgroupError='<div class="alert alert-danger alert-dismissible fade show" role="alert">
...
if(isset($submitSuccess)) echo $submitSuccess;
			...
			<form class="form-group" action="" method="post" >
				<div class="form-group">
					...
					<input type="text"
				name="name" id="fullname" placeholder="Full Name" required pattern="[A-Za-z/\s]+" title="Only lower and upper case and space" class="form-control" value="<?php
...
if(isset($bloodgroupError)) echo $bloodgroupError;
			?>
<div class="form-group">
	<label for="gender">Gender</label>
	<br>
	Male<input type="radio" name="gender" id="gender" value="Male"
	style="margin-left:10px; margin-right:5px;" checked>
	Female<input type="radio" name="gender" id="gender" value="Female"
style="margin-left:5px;" <?php
        
if(isset($gender)){if($gender=="Female") echo "checked";} 
      ?>>
</div>
<?php
...
<div class="form-inline">
	<label for="name">Date of Birth</label><br><br><br>
	<select class="form-control demo-default" id="date" name="day" style="margin-bottom:10px; margin-right: 5px;"required>
      ...
      ?>
					...
					<div class="form-group">
						<label for="contact_no">Contact No</label>
						 <input type="text" name="contact_no"  placeholder="01********" class="form-control" required pattern="^\d{11}$" title="11 numeric characters only" maxlength="11" value="<?php
...
if(isset($cpasswordError)) echo $cpasswordError;
            ...
            <div>
              ...
              <span><b>I am agree to donate my blood and show my Name, Contact Nos. and E-Mail in Blood donors List</b></span>
            </div>
